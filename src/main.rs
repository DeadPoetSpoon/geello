...
const FS_FONT: &[u8] = include_bytes!("../assets/fsong_gb2312.ttf");
#[pollster::main]
async fn main() -> anyhow::Result<()> {
    // let rect = Rect::new((72.502355, 14.986898), (136.08722, 54.563624));
    let rect = Rect::new((102.502355, 14.986898), (136.08722, 54.563624));
    let (width_size, height_size) = (rect.width(), rect.height());
    let size_per_pixel = 0.012f64;
    let (width, height) = (
    ...
    let mut file = File::open("assets/china.geo.json").unwrap();
